<template>
  <div id="themeModal" class="absolute z-10 flex justify-center top-[200px] right-[312px] w-[232px] py-2 rounded-lg bg-white">
    <fieldset>
      <!-- Botón Light -->
      <button 
      ...
      <!-- Botón Dark -->
      <button
      :class="theme === 'dark' ? 'text-[#0C66E4] bg-[#E9F2FF] left-shadow' : 'hover:bg-[#0000001a] left-shadow-hover'"  
        class="relative w-[229px] h-[68px] flex items-center px-3 py-2 gap-2">
      ...
      <!-- Botón Match browser -->
      <button
        :class="theme === 'system' ? 'text-[#0C66E4] bg-[#E9F2FF] left-shadow' : 'hover:bg-[#0000001a] left-shadow-hover'"  
        class="relative w-[229px] h-[68px] flex items-center px-3 py-2 gap-2">
